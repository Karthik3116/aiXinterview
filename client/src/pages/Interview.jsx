...
//     };
//   }, [saveInterviewDataAndGenerateFeedback, assistantCaption, userCaption]);
...
//               {callStatus !== "ACTIVE" && (
//                 <button onClick={handleContinueInterview} className="btn btn-success mt-4 me-2">Continue Interview</button>
//               )}
//               {callStatus === "ACTIVE" && (
//                 <button onClick={handleEndInterview} className="btn btn-danger mt-4">End Interview</button>
//               )}
//             </>
//           )}
//         </>
...
//     if (!subject || numQuestions < 1) return;
//     try {
//       const token = localStorage.getItem('token');
//       const res = await axios.post(
//         'http://localhost:5000/api/interview/generate',
...
//                 <>
//                   <button onClick={handleContinueInterview} className="btn btn-success mt-4 me-2">Continue Interview</button>
//                   <button onClick={handleRetakeInterview} className="btn btn-warning mt-4">Retake Interview</button>
//                 </>
//               )}
//               {callStatus === "ACTIVE" && (
//                 <button onClick={handleEndInterview} className="btn btn-danger mt-4">End Interview</button>
...
//   const handleRetakeInterview = async () => {
//     if (!subject || numQuestions < 1) {
//       alert("Enter subject and valid number of questions to retake.");
//       return;
//     }
//     setPreparingInterview(true); // Set loading for retake
//     try {
//       const token = localStorage.getItem('token');
//       const res = await axios.post(
//         'http://localhost:5000/api/interview/generate',
...
//                     <div className="card-body">
//                       <p>{userCaption || "..."}</p>
//                     {/* Add a button to navigate to feedback directly for testing or review */}
//                     </div>
//                   </div>
//                 </div>
//               </div>
