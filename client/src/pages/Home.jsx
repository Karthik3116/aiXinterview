...
//         setFilteredResults(results);
//         setVisibleCount(itemsPerPage); // Reset visible count for main grid display (if needed, but main grid isn't affected by search)
//     }, [searchTerm, interviews, itemsPerPage]);
...
//         return () => observerRef.current?.disconnect();
//     }, [interviews, visibleCount, itemsPerPage, loading]);
